...
round((round((HOT_USED_MB+COLD_USED_MB)/decode(type,'NORMAL',2,'HIGH',3,1)/1024)+round(REQUIRED_MIRROR_FREE_MB/decode(type,'NORMAL',2,'HIGH',3,1)/1024))*100/round(TOTAL_MB/decode(type,'NORMAL',2,'HIGH',3,1)/1024),2) PCT_USED,type
